...
const ParticleText = ({
  ...
  useEffect(() => {
    ...
    const sampleText = async () => {
      ...
      const left = Math.ceil((metrics as any).actualBoundingBoxLeft || 0);
      const right = Math.ceil((metrics as any).actualBoundingBoxRight || metrics.width);
      const ascent = Math.ceil((metrics as any).actualBoundingBoxAscent || resolvedSize * 0.78);
      const descent = Math.ceil((metrics as any).actualBoundingBoxDescent || resolvedSize * 0.22);
